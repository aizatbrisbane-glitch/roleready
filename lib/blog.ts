...
export const blogArticles: BlogArticle[] = [
  ...
  },
  {
    ...
    sections: [
      {
        id: "intro",
        title: "The Job You Already Applied For Is Back",
        paragraphs: [
          "You know the job.",
          ...
          "Then, weeks or months later, it returned. Same title. Same company. Same suspiciously enthusiastic description of a \"fast-paced environment\". The job you already applied for is suddenly back on LinkedIn, SEEK or another job board, looking very much alive.",
      ...
      },
      {
        ...
        items: [
          {
            heading: "They did not find the right person",
            paragraphs: [
              "Sometimes the employer interviewed candidates but could not find someone with the right combination of skills, experience, salary expectations and cultural fit. The shortlist may have been strong, just not strong enough for the hiring manager to make a decision. Or the employer may have been searching for a unicorn on a donkey budget. Either way, the role gets reposted.",
            ]
          },
          {
            heading: "Their preferred candidate pulled out",
            paragraphs: [
              "A company may have made an offer, only for the successful candidate to accept another job, receive a counteroffer or decide the opportunity was not right for them. That sends the employer back to the beginning, possibly with slightly more realistic expectations.",
            ]
          },
          {
            heading: "The hiring process was paused",
            paragraphs: [
              "Budgets change. Managers leave. Teams restructure. Approvals get delayed. Someone important goes on leave and the recruitment process quietly stops moving. The job may be reposted once the company is ready to hire again.",
            ]
          },
          {
            heading: "The advertisement automatically renewed",
            paragraphs: [
              "Some job boards automatically refresh or renew listings. This can make an old role appear new, even when the employer is already interviewing candidates or has stopped actively reviewing applications. Before assuming the job has risen from the dead, check whether the wording, closing date or job reference number has changed.",
            ]
          },
          {
            heading: "The company is hiring more than one person",
            paragraphs: [
              "A repeated advertisement may be part of ongoing recruitment, particularly for sales, customer service, healthcare, technology, hospitality or other high-volume roles. The business may also be growing and need several people with the same skills.",
            ]
          },
          {
            heading: "The new hire did not work out",
            paragraphs: [
              "The company may have hired someone who resigned quickly, failed probation or discovered that the \"flexible hybrid culture\" meant being flexible enough to come into the office five days a week. One failed hire does not automatically make the company a bad employer. But if the same role keeps appearing every few months, it deserves a closer look.",
            ]
          },
        ]
      },
      {
        ...
        paragraphs: [
          "Possibly. A previous rejection does not always mean you are permanently ruled out. Hiring decisions are based on the candidates available at a particular time, the needs of the team and the preferences of the people involved. The situation may be different now.",
          "Consider reapplying when:",
        ],
        bullets: [
          "The job description has changed.",
          "You have gained new skills or experience since your last application.",
          "You have meaningfully improved your resume.",
          "The company is recruiting for multiple positions.",
          "Enough time has passed for the hiring needs to have shifted.",
      ...
      },
      {
        ...
        paragraphs: [
          "You might also reapply if you never received a response at all. Your first application may not have reached a human, especially if your resume was not well aligned with the role or easily read by the employer's applicant tracking system.",
          ...
          "Do not simply resend the exact same application and hope the recruitment gods have become more generous. Update your resume, review the advertisement carefully, strengthen your opening summary and make your most relevant experience easier to find. Show the employer why your application deserves another look.",
        ]
      },
      {
        ...
        paragraphs: [
          "Reapplying is not always the best use of your time. Think twice about the following situations.",
        ],
        items: [
          {
            heading: "The role is constantly advertised",
            paragraphs: [
              "If the same job appears every few weeks, the company may have high turnover, unrealistic expectations or a hiring process that is not working. One repost is normal. Six reposts starts to look like a subscription service.",
            ]
          },
          {
            heading: "The description keeps changing dramatically",
            paragraphs: [
              "A role that moves from coordinator to manager responsibilities, then adds sales targets, administration, events and executive support may indicate that the employer does not know what it needs. That confusion rarely disappears once someone is hired.",
            ]
          },
          {
            heading: "The salary has fallen but the expectations have grown",
            paragraphs: [
              "Sometimes a reposted advertisement returns with a lower salary and a longer list of responsibilities. That is not a second chance. That is a warning label.",
            ]
          },
          {
            heading: "The company previously treated you poorly",
            paragraphs: [
              "Recruitment provides an early glimpse of how an organisation communicates. If the company cancelled interviews without explanation, asked you to complete hours of unpaid work, disappeared after multiple interviews or behaved disrespectfully, consider whether you want to restart that relationship. A company does not need to offer you a job, but it should still treat your time with basic professionalism.",
            ]
          },
          {
            heading: "You have applied several times without progress",
            paragraphs: [
              "There is persistence, and then there is repeatedly knocking on a door that nobody intends to open. If you have applied for the same role multiple times without reaching an interview, focus your energy elsewhere. You may have better luck applying for a different position within the company or building experience that closes the most obvious gaps.",
            ]
          },
        ]
      },
      {
        ...
        paragraphs: [
          "The biggest trap with zombie job advertisements is forgetting that you have seen them before. Job descriptions are often copied, slightly renamed or reposted on multiple platforms. What looks like a fresh opportunity may be the same role you applied for three months ago at 11.47 pm while emotionally supported by a packet of biscuits.",
          "Koalapply helps you keep track of the jobs you have applied for, the resume version you used and where each application sits. That means you can quickly check whether the job is genuinely new, previously rejected or still sitting in the mysterious status known as \"under review\". It also stops you from wasting time recreating an application you have already submitted.",
        ]
      },
      {
        id: "three-questions",
