...
export function LiveDashboard({ initialMetrics, initialEvents, emailByUserId }: LiveDashboardProps) {
  const { metrics, events, latestEvent } = useLiveMetrics(initialMetrics, initialEvents, emailByUserId);
