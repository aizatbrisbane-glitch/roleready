    ...
    <main className="min-h-screen bg-slate-50 px-4 py-5 pb-36 md:px-8 md:py-10 md:pb-10 xl:px-10">
      <div className="mx-auto max-w-[1520px] overflow-x-clip">
        ...
        <div className="min-w-0 space-y-6">
            ...
            {(jobDescriptionLooksShort || !!displayJob.note) && !hasDocuments && <JobDescriptionEditor applicationId={application.id} initialDescription={displayJob.note ? "" : job.description} hasDocuments={hasDocuments} />}
            ...
            <ApplicationDetailClient
              ...
              strengthenCount={application.strengthen_count ?? 0}
            />
